# Contributing to blackroad-products-gallery
...
```bash
# Clone your fork
git clone https://github.com/YOUR_USERNAME/blackroad-products-gallery.git
cd blackroad-products-gallery

# Add upstream remote
git remote add upstream https://github.com/BlackRoad-OS/blackroad-products-gallery.git
